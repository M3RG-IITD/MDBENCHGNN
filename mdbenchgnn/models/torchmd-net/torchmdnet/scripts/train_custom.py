...
from torchmdnet.data_custom import DataModule
...
def get_args():
    ...
    parser.add_argument('--energy-key', type=str, default='energy', help='energy key in npz file')
    ...
    save_argparse(args, os.path.join(args.log_dir, "input.yaml"), exclude=["conf"])# log directory saves the yaml as well
