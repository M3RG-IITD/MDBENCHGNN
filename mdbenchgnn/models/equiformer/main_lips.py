...
import datasets.pyg.lips as lips_dataset
...
def main(args):
    ...
    # seed=args.seed)
    train_dataset = lips_dataset.get_lips_datasets(args.data_path  + "train")
                    
    val_dataset = lips_dataset.get_lips_datasets(args.data_path  + "val")
                    
    test_dataset = lips_dataset.get_lips_datasets(args.data_path  + "test")
