...
class LIPS(InMemoryDataset):
    ...
    def __init__(self, root, transform=None, pre_transform=None):
        ...
        super(LIPS, self).__init__(root, transform, pre_transform)# it runs the process function
    ...
    def get(self, idx):
        ...
        return super(LIPS, self).get(idx - self.offsets[data_idx])
