...
def main():
    calculator = MACECalculator(model_path='example/lips/botnet/BOTNet_model_lips_50_swa.model', device='cuda', default_dtype='float64')
    calculator.model.double() # change model weights type to double precision(hack to avoid error)
    device = "cuda"; model_name = "botnet"
    system = "lips"
